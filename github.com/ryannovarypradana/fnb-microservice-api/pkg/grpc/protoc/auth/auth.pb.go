...
// User message to be returned after registration
type User struct {
...
// Response for both Register and RegisterStaff
...
type RegisterStaffRequest struct {
	...
	Password  string `protobuf:"bytes,3,opt,name=password,proto3" json:"password,omitempty"`
	Role      string `protobuf:"bytes,4,opt,name=role,proto3" json:"role,omitempty"`
	CompanyId string `protobuf:"bytes,5,opt,name=company_id,json=companyId,proto3" json:"company_id,omitempty"` // Opsional
	StoreId   string `protobuf:"bytes,6,opt,name=store_id,json=storeId,proto3" json:"store_id,omitempty"`       // Opsional
}
...
func (x *RegisterStaffRequest) GetCompanyId() string {
	if x != nil {
		return x.CompanyId
	}
	return ""
...
var file_proto_auth_auth_proto_rawDesc = []byte{
	...
	0x68, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x04, 0x61, 0x75, 0x74, 0x68, 0x22, 0x54, 0x0a,
	...
	0x6f, 0x6c, 0x65, 0x22, 0x57, 0x0a, 0x0f, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x52,
	...
	0x28, 0x09, 0x52, 0x08, 0x70, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x22, 0x32, 0x0a, 0x10,
	...
	0x22, 0xaa, 0x01, 0x0a, 0x14, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x53, 0x74, 0x61,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x73, 0x74, 0x6f, 0x72, 0x65, 0x49, 0x64, 0x22, 0x40, 0x0a,
	...
	0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x32, 0xbf, 0x01, 0x0a, 0x0b, 0x41, 0x75, 0x74, 0x68, 0x53,
	...
	0x65, 0x12, 0x43, 0x0a, 0x0d, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x53, 0x74, 0x61,
	0x66, 0x66, 0x12, 0x1a, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74,
	0x65, 0x72, 0x53, 0x74, 0x61, 0x66, 0x66, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x16,
	...
	0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x72, 0x79, 0x61, 0x6e, 0x6e, 0x6f, 0x76, 0x61, 0x72,
	0x79, 0x70, 0x72, 0x61, 0x64, 0x61, 0x6e, 0x61, 0x2f, 0x66, 0x6e, 0x62, 0x2d, 0x6d, 0x69, 0x63,
	0x72, 0x6f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2d, 0x61, 0x70, 0x69, 0x2f, 0x70, 0x6b,
	0x67, 0x2f, 0x67, 0x72, 0x70, 0x63, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x2f, 0x61, 0x75,
...
var file_proto_auth_auth_proto_depIdxs = []int32{
	...
	3, // 2: auth.AuthService.RegisterStaff:input_type -> auth.RegisterStaffRequest
	4, // 3: auth.AuthService.Login:input_type -> auth.LoginRequest
	2, // 4: auth.AuthService.Register:output_type -> auth.RegisterResponse
	2, // 5: auth.AuthService.RegisterStaff:output_type -> auth.RegisterResponse
